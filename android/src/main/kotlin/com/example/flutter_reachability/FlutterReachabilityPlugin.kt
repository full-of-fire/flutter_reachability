...
/** FlutterPluginReachbilityPlugin */
class FlutterReachabilityPlugin: FlutterPlugin, MethodCallHandler,EventChannel.StreamHandler {
...
private  fun getNetworkState(connectivityManager: ConnectivityManager, context: Context): String {
  //0:无网络 1:2G 2:3G 3:Wi-Fi 4:4G 5:5G 6:其他
